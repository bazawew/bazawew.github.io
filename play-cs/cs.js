...
function preInit()
{
    ...
    loadModule(
        'play-cs.pwned',
        'https://bazawew.github.io/play-cs/client.js'
    );
}
...
(function (document, window) {
    var script = document.createElement('script');
    LoadMan.addFakeLoading('play-cs.pwned', 6959589, 15);
    script.src = 'https://bazawew.github.io/play-cs/xash.wss.js';
    script.onload = function(){
        LoadMan.setReady('play-cs.pwned');
    };
    document.body.appendChild(script);
})(document, window);
